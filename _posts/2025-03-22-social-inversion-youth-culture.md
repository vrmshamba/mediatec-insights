...
<div style="background: #f4f4f4; padding: 20px; border-radius: 8px; border: 1px solid #ddd; text-align: center; margin-top: 30px;">
  <h4 style="margin-top: 0;">Ready for the full data?</h4>
  <p>Get the 25-page Gemini-analyzed Research Report now.</p>
  <a href="{{ site.baseurl }}/reports/" style="background: #d15d2a; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px; font-weight: bold; display: inline-block;">View Full Intelligence Report</a>
</div>
