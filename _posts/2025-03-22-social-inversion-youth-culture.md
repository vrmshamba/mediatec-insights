...
<div style="background: #f4f4f4; padding: 30px; border-radius: 8px; border: 1px solid #ddd; text-align: center; margin-top: 30px; margin-bottom: 30px;">
  <h3 style="margin-top: 0; color: #111;">Ready for the full data?</h3>
  <p style="color: #444;">Get the 25-page Gemini-analyzed Research Report now.</p>
  <a href="{{ site.baseurl }}/reports/" style="background: #d15d2a; color: white; padding: 15px 30px; text-decoration: none; border-radius: 4px; font-weight: bold; display: inline-block; font-size: 16px;">View Full Intelligence Report &rarr;</a>
</div>
